...
const { listBundles, createBundleHandler, advanceBundleHandler } = require('../controllers/bundle.controller');
...
router.patch('/:id/advance', authenticate, requireRole(['manager']), advanceBundleHandler);
